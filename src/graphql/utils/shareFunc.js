...
module.exports = {
  ...
  getTranslateSector: sector =>
    ({
      ...
      'Residential Construction': 'Imobiliário',
      Steel: 'Siderúrgico',
      ...
      'Information Technology Services': 'Serviços de Tecnologia',
      'Software—Infrastructure': 'Serviços de Tecnologia',
      'Software—Application': 'Serviços de Tecnologia',
      'Credit Services': 'Serviços de Tecnologia',
      'Farm Products': 'Agricultura',
      'Internet Retail': 'Varejo',
      'Education & Training Services': 'Educação',
      'Footwear & Accessories': 'Calçados',
      'Integrated Freight & Logistics': 'Serviços Diversos',
